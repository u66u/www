...
const Home = ({ posts }: { posts: Writing[] }) => {
  ...
  <div className="gradienta rounded-xl p-5 ">
    ...
    <h1 className='font-semibold text-lg text-white mb-1.5'>
            ...
            <p>
            I work at <a className="focusable rounded-sm font-medium text-zinc-800 underline decoration-green-500 decoration-2 underline-offset-2 transition duration-100 hover:text-green-500 hover:decoration-green-500/30 focus:text-lime-500 focus:ring-lime-500/40 dark:text-white dark:decoration-lime-400 dark:hover:text-lime-400 dark:hover:decoration-lime-400/30 dark:focus:text-lime-400 dark:focus:ring-lime-400/40" href="https://www.seleri.agency/" rel="noreferrer" target="_blank">Seleri Agency -{'>'}</a> and <a className="focusable rounded-sm font-medium text-zinc-800 underline decoration-violet-500 decoration-2 underline-offset-2 transition duration-100 hover:text-violet-500 hover:decoration-violet-500/30 focus:text-violet-500 focus:ring-violet-500/40 dark:text-white dark:decoration-violet-400 dark:hover:text-violet-400 dark:hover:decoration-violet-400/30 dark:focus:text-violet-400 dark:focus:ring-violet-400/40" href="https://www.fabrilab.net/" rel="noreferrer" target="_blank">Caelestis Labs -{'>'}</a> 
            </p>
            <br /> <p>I believe that humans should be able to live for 200 years, that's why I'm learning biology, and expirementing with different aging mechanisms. In my free time I like to solve math problems and code. </p>
            <br /> 
            This website is an outlet for my thoughts, ideas, and projects.
